 ...
 * to create highly constrained objects with the Amp provider.
 *
 * Topics covered:
 ...
 *
 * Run: npx tsx examples/generate-object-constraints.ts
 */
...
console.log('=== Amp SDK: Constrained Object Generation ===\n');
...
async function main() {
  try {
    ...
    console.log('\n💡 Tip: Clear descriptions help AI understand the constraints better!');
  } catch (error) {
