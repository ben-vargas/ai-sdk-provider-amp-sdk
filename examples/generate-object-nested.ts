 ...
 *
 * Run: npx tsx examples/generate-object-nested.ts
 */
...
console.log('=== Amp SDK: Nested Object Generation ===\n');
...
async function main() {
  try {
    ...
    console.log('- Limit recursion depth for tree-like data');
  } catch (error) {
